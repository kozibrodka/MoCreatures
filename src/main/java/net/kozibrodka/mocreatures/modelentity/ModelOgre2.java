...
public class ModelOgre2 extends Biped
{
    ...
    public ModelOgre2()
    {
        ...
        field_619.method_1818(1.0F, -5F, -4F, 1, 1, 1, 0.0F);
        field_619.setRotationPoint(0.0F, 0.0F, 0.0F);
        field_626 = new Cuboid(0, 0);
        field_626.method_1818(-4F, -1F, -4F, 1, 1, 1, 0.5F);
        field_626.setRotationPoint(0.0F, 0.0F, 0.0F);
        field_621 = new Cuboid(0, 16);
        field_621.method_1818(-6F, -3F, -5F, 12, 8, 8, 2.3F);
        field_621.setRotationPoint(0.0F, 0.0F, 0.0F);
        field_622 = new Cuboid(40, 0);
        field_622.method_1818(-7F, -2F, -2F, 4, 18, 4, 1.5F);
        field_622.setRotationPoint(-5F, -14F, 0.0F);
        field_623 = new Cuboid(40, 0);
        field_623.mirror = true;
        field_623.method_1818(3F, -2F, -2F, 4, 18, 4, 1.5F);
        field_623.setRotationPoint(5F, -14F, 0.0F);
        field_624 = new Cuboid(0, 0);
        field_624.method_1818(-2F, 9F, -6F, 4, 2, 8, 1.5F);
        field_624.setRotationPoint(-4F, 0.0F, 0.0F);
        field_625 = new Cuboid(0, 0);
        field_625.mirror = true;
        field_625.method_1818(-2F, 9F, -6F, 4, 2, 8, 1.5F);
        field_625.setRotationPoint(4F, 0.0F, 0.0F);
    }

    public void render(float f, float f1, float f2, float f3, float f4, float f5, boolean flag)
    {
        setAngles(f, f1, f2, f3, f4, f5, flag);
    ...
    public void setAngles(float f, float f1, float f2, float f3, float f4, float f5, boolean flag)
    {
