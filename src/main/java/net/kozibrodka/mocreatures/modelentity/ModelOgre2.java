...
public class ModelOgre2 extends BipedEntityModel
{
    ...
    public ModelOgre2()
    {
        ...
        head.addCuboid(1.0F, -5F, -4F, 1, 1, 1, 0.0F);
        head.setPivot(0.0F, 0.0F, 0.0F);
        ears = new ModelPart(0, 0);
        ears.addCuboid(-4F, -1F, -4F, 1, 1, 1, 0.5F);
        ears.setPivot(0.0F, 0.0F, 0.0F);
        body = new ModelPart(0, 16);
        body.addCuboid(-6F, -3F, -5F, 12, 8, 8, 2.3F);
        body.setPivot(0.0F, 0.0F, 0.0F);
        rightArm = new ModelPart(40, 0);
        rightArm.addCuboid(-7F, -2F, -2F, 4, 18, 4, 1.5F);
        rightArm.setPivot(-5F, -14F, 0.0F);
        leftArm = new ModelPart(40, 0);
        leftArm.mirror = true;
        leftArm.addCuboid(3F, -2F, -2F, 4, 18, 4, 1.5F);
        leftArm.setPivot(5F, -14F, 0.0F);
        rightLeg = new ModelPart(0, 0);
        rightLeg.addCuboid(-2F, 9F, -6F, 4, 2, 8, 1.5F);
        rightLeg.setPivot(-4F, 0.0F, 0.0F);
        leftLeg = new ModelPart(0, 0);
        leftLeg.mirror = true;
        leftLeg.addCuboid(-2F, 9F, -6F, 4, 2, 8, 1.5F);
        leftLeg.setPivot(4F, 0.0F, 0.0F);
    }
